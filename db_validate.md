...
8. Кроме ошибок нехватает рекоментаций, их как раз можно возвращать в результате работы функции:
...
15. Добавить проверку отсутствия дубликатов ограничений таблицы (`has_not_duplicate_constraint`):
```sql
with s as (
