...
<tr>
    ...
    <td colspan="1">Описание помогает лучше понять назначение таблицы и на сколько удачно названа таблица исходя из описания.
...
<tr>
    ...
    <td colspan="1">Описание помогает лучше понять назначение колонки и на сколько удачно названа таблица исходя из описания.
                    В дельнейшем тандем названия и описания упрощают понимание и поддержку кода.
