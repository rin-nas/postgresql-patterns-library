create or replace function public.phone_format(
...
begin
    ...
    if phone = '' or phone_example = '' then
        return '';
    end if;
...
comment on function public.phone_format(
    phone text,
    phone_example text,
...
do $$
    begin
        --positive
        assert public.phone_format('79651234567') = '+79651234567';
        assert public.phone_format('210', '+7') = '+210';
        assert public.phone_format('7', '+210') = '+7';

        assert public.phone_format('+79651234567', ' 00000000000 ') = '79651234567';
        assert public.phone_format('79651234567', '0  0000000000') = '7 9651234567';
        assert public.phone_format('79651234567', '0 0') = '7 9651234567';
        assert public.phone_format('79651234567', '00 0') = '79 651234567';
        assert public.phone_format('79651234567', '000 0') = '796 51234567';
        assert public.phone_format('79651234567', '+0 (000) 0000000') = '+7 (965) 1234567';
        assert public.phone_format('79651234567', 'моб. +0 000 000-00-00 доп 123') = 'моб. +7 965 123-45-67 доп 123';

        assert public.phone_format('21079651234567', '210 0000 0000000', true) = '210 7965 1234567';

        --negative
        assert public.phone_format('', '000') = '';
        assert public.phone_format('000', '') = '';
        assert public.phone_format(null) is null;
    end;
$$;
