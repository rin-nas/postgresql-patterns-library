...
create or replace function public.ping(
    connection_str text,
    remote_server_addr out inet, -- для подключения по хосту узнаём его IP
    ...
    from public.dblink(
               ...
               format($sql$
                      select
                          ...
                          inet_server_addr() as remote_server_addr,
