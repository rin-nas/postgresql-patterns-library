...
do $$
    begin
        assert public.bit_from_bytea('\xD9D8E6B0E34C') = B'110110011101100011100110101100001110001101001100';
        assert public.bit_from_bytea('\x11d481c8e032988e9763fd2780') = B'00010001110101001000000111001000111000000011001010011000100011101001011101100011111111010010011110000000';
    end;
$$;
