...
comment on function app_progress(
    ...
    Дописывает или заменяет прогресс выполнения (в процентах) длительной процедуры в application_name.
    Сценарий использования.
    Внутри процедуры после выполнения части работы нужно вызывать функцию app_progress().
