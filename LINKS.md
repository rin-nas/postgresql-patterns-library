...
1. https://patroni.readthedocs.io/en/latest/ — Patroni documentation
1. https://postgrespro.ru/clusters/patroni — Отказоустойчивый кластер СУБД Postgres Pro на основе Patroni
1. https://platformv.sbertech.ru/docs/public/PSQ/7.1.2/common/documents/architecture-components/patroni/patroni-main.html — Patroni 3.2
