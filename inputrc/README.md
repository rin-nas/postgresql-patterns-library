...
Добавляет удобство в терминал. В командной строке можно быстро смотреть историю **частично введённых команд**, нажимая на клавиатуре клавиши со стрелками ввер-вниз.
