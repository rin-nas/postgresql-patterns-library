...
Добавляет удобство в терминал. В командной строке можно быстро смотреть историю **частично введённых команд**, если на клавиатуре нажимать клавиши со стрелками вверх-вниз.
