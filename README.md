...
**[Администрирование](#Администрирование)**
   ...
   1. [Как терминировать простаивающие запросы, клиенты которых долго не забирают результаты запросов?](#Как-терминировать-простаивающие-запросы-клиенты-которых-долго-не-забирают-результаты-запросов)
...
### Как терминировать простаивающие запросы, клиенты которых долго не забирают результаты запросов?
