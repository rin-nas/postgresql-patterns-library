...
**[Администрирование](#Администрирование)**
   ...
   1. [Как терминировать простаивающие соединения, клиенты которых долго не забирают результаты запросов?](#Как-терминировать-простаивающие-соединения-клиенты-которых-долго-не-забирают-результаты-запросов)
...
### Как терминировать простаивающие соединения, клиенты которых долго не забирают результаты запросов?
...
* * * * * psql -U postgres -c "SELECT pg_terminate_backend(pid) FROM pg_stat_activity WHERE (now() - query_start) > interval '20 minutes' AND state ~ 'idle' AND wait_event='ClientRead'"
```
