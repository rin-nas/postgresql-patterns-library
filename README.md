...
**[Получение пользовательских данных](#Получение-пользовательских-данных)**
   1. [Валидация и домены](#Валидация-и-домены)
      ...
      1. [Как проверить банковские реквизиты (расчётный счёт, корреспондентский счёт) на валидность?](#Как-проверить-банковские-реквизиты-расчётный-счёт-корреспондентский-счёт-на-валидность)
...
#### Как проверить банковские реквизиты (расчётный счёт, корреспондентский счёт) на валидность?
