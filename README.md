...
**[Получение пользовательских данных](#Получение-пользовательских-данных)**
   ...
   1. [Строки](#Строки)
      ...
      1. [Как загрузить в таблицу большой файл в формате `csv.xz`?](#Как-загрузить-в-таблицу-большой-файл-в-формате-csv-xz)
...
#### Как загрузить в таблицу большой файл в формате `csv.xz`?
