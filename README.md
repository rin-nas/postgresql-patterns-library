...
**[Администрирование](#Администрирование)**
   ...
   1. [Как получить список самых популярных медленных SQL запросов?](#Как-получить-список-самых-популярных-медленных-SQL-запросов)
...
### Как получить список самых популярных медленных SQL запросов?
