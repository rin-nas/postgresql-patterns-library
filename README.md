...
**[Администрирование](#администрирование)**
   ...
   1. [Как получить топологию кластера СУБД?](#как-получить-топологию-кластера-субд)
...
Возвращает серверы: мастер и зависимые реплики, включая каскадные.

Представление [`pg_cluster_topology.sql`](views/pg_cluster_topology.sql)
