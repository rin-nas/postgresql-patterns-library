...
COMMIT;
```
Если какие-либо запросы в миграции приведут к [блокированию таблиц](https://github.com/dataegret/pg-utils/blob/master/sql/locktree.sql), то транзакция с миграцией откатится, а ваши пользователи не пострадают.
