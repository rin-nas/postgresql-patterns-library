...
**[Получение пользовательских данных](#Получение-пользовательских-данных)**
   ...
   1. [Массивы](#Массивы)
      1. [Как сделать аналог типа `set` в MySQL?](#Как-сделать-аналог-типа-set-в-MySQL)
...
#### Как сделать аналог типа `set` в MySQL?
...
Применение: выгрузка из БД большого количества данных примерно одного объёма в каждой пачке. Например, индексирование данных в поисковых движках типа [Manticore](https://manticoresearch.com/), [Sphinx](http://sphinxsearch.com/), [Solr](https://solr.apache.org/), [Elastic Search](https://www.elastic.co/).
...
*/
```
Если какие-либо запросы в миграции приведут к долгому [блокированию таблиц](https://postgres.ai/blog/20211018-postgresql-lock-trees), то транзакция с миграцией откатится, а ваши пользователи не пострадают.
