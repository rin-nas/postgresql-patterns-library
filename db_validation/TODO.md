...
1. Названия объектов БД
   ...
   1. Название колонки для первичного ключа: `id` или `guid` (сделать настраиваемым)
   ...
   1. Добавить проверку именования последовательностей по шаблону `{table}_{column}_seq`. Некоторые фреймворки закладываются на эти названия.
1. Индексы
